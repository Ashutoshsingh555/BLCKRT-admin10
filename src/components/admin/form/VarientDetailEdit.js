        ...
        <div>
          ...
          <div key={val.index} className='row'>
            <div class="form-group col-sm-4">
              <label>Sort:</label>
             <input type="number" defaultValue={val.sort || ''} name="sort" data-id={idx} id={sort} className="form-control " />
           </div>
           <div class="form-group col-sm-4">
              <label>SKU</label>
              <input type="text" defaultValue={val.sku || ''} name="sku"  data-id={idx} id={sku} className="form-control " />
            </div>
            <div class="form-group col-sm-4">
              <label>Weight/Quantity</label>
              <input type="text" defaultValue={val.waightunitno || ''} name="waightunitno" id={waightunitno} data-id={idx} className="form-control " />
            </div>
          </div>
          <div  className='row'>
             <div class="form-group col-sm-4">
               <label>Unit</label>
               <input type="text" defaultValue={val.unit || ''} name="unit" id={unit} data-id={idx} className="form-control " />
            </div>
            <div class="form-group col-sm-4">
              <label>MRP <em style={{color:"tomato"}}>*</em></label>
              <input type="number" defaultValue={val.mrp || ''} name="mrp" id={mrp} data-id={idx} className="form-control " />
            </div>
            <div class="form-group col-sm-4">
              <label>Discount(%) <em style={{color:"tomato"}}>*</em></label>
              <input type="number" defaultValue={val.discount || ''} name="discount" id={discount} data-id={idx} className="form-control " />
            </div>
          </div>
          <div  className='row'>
             <div class="form-group col-sm-4">
                <label>Price <em style={{color:"tomato"}}>*</em></label>
                <input type="number" defaultValue={val.price || ''} name="price" id={price} data-id={idx} className="form-control " />
             </div>
              <div class="form-group col-sm-4">
                  <label>Stock  <em style={{color:"tomato"}}>*</em></label>
                  <input type="number" defaultValue={val.stock || ''} name="stock" id={stock} data-id={idx} className="form-control " />
              </div>
              <div class="form-group col-sm-4">
                  <label>Min Stock Alert <em style={{color:"tomato"}}>*</em></label>
                  <input type="number" defaultValue={val.minstock || ''}  name="minstock" id={minstock} data-id={idx} className="form-control " />
              </div>
