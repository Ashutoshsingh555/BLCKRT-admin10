...
export default class addEditCoupon extends Component {
  ...
  componentDidMount(){
    ...
    async submit(e){
        ...
        swal({
            title: "Are you sure?",
            text: "You want to Add New Loyality Coupon",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then(async (success) => {
                if (success) {
                    let list = await GetLoyaltyCouponDetails.addLoyaltyCoupon(config);
       ...
       return (
            <div>
             <form onChange={(e)=>{this.handleChange(e)}}>
                    ...
                    <li className="breadcrumb-item active"><a>Add Loyality Point Coupon</a></li>
                </ol>
                ...
                <div className='row py-4 mx-4'>
                    <div className='col-sm-3'>
                         <div className="form-group my-4">
                            ...
                            <input type="number" id="inputPassword5" name="AmountsOff"  class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock"/>
                        </div>
                    </div>
                    <div className='col-sm-3'>
                         <div className="form-group my-4">
                            <label for="inputPassword5" class="form-label">Loyality Point<em style={{color:"tomato"}}>*</em></label>
                            <input type="number" id="inputPassword5"  name="loyaltyPoints" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock"/>
                        </div>
                    </div>
                </div>
