...
export default class giftAdd extends Component {
    constructor(props){
        super(props);
  ...
  onChangehandle =  (e) =>{
    ...
    const {  offerName, offerType,categoryId,status} = this.state 
        ...
        swal({
            title: "Are you sure?",
            text: "You want to Add New Gift offers",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then(async (success) => {
                if (success) {
                    let list = await GetGiftDetails.addGiftOffers(formData,config);
      ...
      return (
            <div className='settingbody'>
                 <ol className="breadcrumb mb-30 mx-4 my-4">
                    ...
                    <li className="breadcrumb-item active"><a>Add Gift Product</a></li>
                </ol>
                    ...
                    <div className='row my-2'>
                            ...
                            <div className="form-group">
                                <label htmlFor="name" class="form-label">Offer Type<em style={{ color: "tomato" }}>*</em></label>
                                 <form class="d-flex" onChange={(e)=>{this.setState({offerType:e.target.value})}}>
                                            <select   style={{padding:"4px",borderRadius:"2px", width:"100%"}} >  
                        ...
                        <div className='col-sm-6'>
                             <div className="form-group">
                                ...
                                <input type="text" id="sortdsc" name="sortdsc" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock" />
                            </div>
                        </div>
                           <div className='col-sm-6'>
                             <div className="form-group">
                                <label htmlFor="name" class="form-label">Description<em style={{ color: "tomato" }}>*</em></label>
                                   <input type="text" id="dsc" name="dsc" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock" />
                                </div>
                            </div>
                          ...
                          <div className='col-sm-6'>
                             <div className="form-group">
                                ...
                                <input type="text" id="brand" name="brand" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock" />
                            </div>
                        </div>
                           <div className='col-sm-6'>
                             <div className="form-group">
                                <label htmlFor="name" class="form-label">Quantity<em style={{ color: "tomato" }}>*</em></label>
                                   <input type="text" id="qty" name="qty" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock" />
                                </div>
                            </div>
                        ...
                        <div className='col-sm-6'>
                             <div className="form-group">
                                ...
                                <input type="text" id="mrp" name="mrp" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock" />
                            </div>
                        </div>
                           <div className='col-sm-6'>
                             <div className="form-group">
                                <label htmlFor="name" class="form-label">Offer Discount<em style={{ color: "tomato" }}>*</em></label>
                                   <input type="text" id="discount" name="discount" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock" />
                                </div>
                            </div>
                          ...
                          <div className='row my-2'>
                            ...
                            <div className='col-sm-6'>
                                <div className="form-group">
                                    ...
                                    <input type="text" id="totalPrice" name="totalPrice" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock" />
                                </div>
                            </div>:null}
                                  <div className='col-sm-6'>
                                <div className="form-group">
                       ...
                       <div className='my-2 py-2 m-4'>
                           <div className="img_wrp mx-2">
                                <div style={{width:"100%"}}> 
                                    ...
                                    {
                                    this.state.filselected? <img  width="100px" class="rounded float-left" height="105px"  src={ URL.createObjectURL(this.state.photo)} alt="img "/>:null
                                    }
                                </div>
                            </div>
                            </div>
