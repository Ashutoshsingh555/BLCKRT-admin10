...
export default class UpdateProductPrice extends Component {
       constructor(props){
        super(props)
        this.state={
            files:"",
      ...
      async getinventory(){
            let list = await getBulkImportExportDetails.exportvarients();
    ...
    downloadFile=(datas=this.state.getlist)=>{
       ...
       FileSaver.saveAs(data, "Product_Varients"+".xlsx")
   ...
   handleSubmit = (e) => {
        ...
        swal({
            title: "Are you sure?",
            text: "You want to Update  Product Varients Price ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then(async (success) => {
                if (success) {
                    let list = await getBulkImportExportDetails.updateProductPrice(formData,config);
    ...
    return (
      <div className='mx-4 my-4'>
             <ol className="breadcrumb mb-30">
                    ...
                    <li className="breadcrumb-item"><a>Product Varients Price</a></li>
                </ol>
                <hr></hr>
                <div className='row mx-2'>
                    <div className='col-sm-8'>
                        <h6 className='text-danger'>please download the product varients sheet first before upload new inventory excell sheet</h6>

                    </div>
                     <div className='col-sm-4'>
                         <button onClick={(e)=>this.downloadFile()} className='btntopsc btn text-light'>Download  Product Varients Price</button>
          ...
          <form>
            <table className="table  mx-2 border">
                <thead>
                    <tr className='py-2'>
                    <th className="col-sm-3"><h5>Update Product Varients Price </h5></th>
