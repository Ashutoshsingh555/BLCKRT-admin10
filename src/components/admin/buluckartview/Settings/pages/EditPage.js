...
export default class EditPage extends Component {
   ...
   const config = {
        ...
        swal({
            title: "Are you sure?",
            text: "You want to Update New page Contains",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then(async (success) => {
                if (success) {
                    let list = await GetSettingPageDetails.getUpdatePage(config);
                ...
                <div className='container py-4'>
                    <form>
                        <div className='form-group col-sm-4'>
                            ...
                            <select   name="Page" value={this.state.Page} onChange={(e) => this.setState({Page:e.target.value})} style={{padding:"4px",borderRadius:"2px", width:"100%"}} >                               
