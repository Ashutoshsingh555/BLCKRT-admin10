...
export default class editFaq extends Component {
    ...
    const config = {
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    let list = await GetFaqDetails.getUpdateFaq(config);
      ...
      <div className='mx-2 my-4'>
          <div>
               <ol className="breadcrumb mb-30 mx-4 my-4">
                    ...
                    <li className="breadcrumb-item active"><a>Edit Faq</a></li>
                </ol>
          </div>
          <form onChange={(e)=>{this.handlechange(e)}}>
             <div className="form-group col-sm-2">
                <label for="inputPassword5" className="form-label">Category*</label>
                <select id="status"  value={this.state.Category} name="Category" className=" w3-input w3-border form-control">
             ...
             <div className="form-group col-sm-8">
                ...
                <textarea type="text" value={this.state.Question}   style={{ minHeight: "10em"}} name="Question" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock"/>
            </div>
            ...
            <div className='row mx-4 my-4'>
                <div className='col-sm-1'>
                    ...
                    <button  onClick={(e)=>{this.handleBack(e)}} className="btntopsc btn text-light">Go Back</button>
                </div>
            </div>
