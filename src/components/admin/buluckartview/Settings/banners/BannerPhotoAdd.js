...
export default class BannerPhotoAdd extends Component {
    constructor(props){
        super(props);
  ...
  onChangehandle =  (e) =>{
    ...
    async submit(e){
        ...
        e.preventDefault();
    const {  imageCaption, BannerId,categoryId,links,status} = this.state 
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    let list = await GetBannerDetails.addBanner2(formData,config);
      ...
      return (
            <div className='settingbody'>
                 <ol className="breadcrumb mb-30 mx-4 my-4">
                    ...
                    <li className="breadcrumb-item active"><a>Add Banner Photos</a></li>
                </ol>
                ...
                <div className='formbody'>
                    <div className='col-sm-6'>
                        <form onChange={(e)=>this.handleChange(e)}>
                            ...
                            <div className="form-group col-sm-8 py-2 my-4">
                                <label for="imageCaption" clasName="form-label">Image Caption <em style={{color:"tomato"}}>*</em></label>
                            
                                <input type="text" name="imageCaption" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock"/>
                            </div> 
