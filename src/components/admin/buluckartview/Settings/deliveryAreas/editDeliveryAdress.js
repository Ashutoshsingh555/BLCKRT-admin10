...
export default class editDeliveryAdress extends Component {
    constructor(props){
        super(props);
        ...
        this.state ={
            areaId:self.id,
            Zone:self.Zone,
            DeliveryAreaName:self.DeliveryAreaName,
            MinimumOrderAmount: self.MinimumOrderAmount,
            ShippingFee:self.ShippingFee,
            allowcustomers:self.allowcustomers,
            AdditionalNote:self.AdditionalNote,
            ChargeShipping:self.ChargeShipping
    ...
    async submit(e){
        ...
        swal({
            title: "Are you sure?",
            text: "You want to UpdateAdress area",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then(async (success) => {
                if (success) {
                    let list = await GetDeliveryAreas.getUpdatdeliverysArea(config);
                    ...
                    <div className='col-sm-10'>
                        <form  onChange={(e)=>this.handleChange(e)}>
                            <div className="form-group col-sm-4">
                                ...
                                <input type="text" id="Zone" defaultValue={this.state.Zone} name='Zone' class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock"/>
                            </div>
                             <div className="file-area col-sm-10">
                                <div className="form-group">
                                 <label>Delivery Area Name *</label>
                                   <div className="form-group">
                                        <textarea id="story"  defaultValue={this.state.DeliveryAreaName} name="DeliveryAreaName"   rows="5" cols="80"></textarea>
                                  </div>
                               </div>
                                </div>
                                ...
                                <div className="form-group col-sm-4">
                                    ...
                                    <input type="number"   defaultValue={this.state.MinimumOrderAmount} id="MinimumOrderAmount" name='MinimumOrderAmount' class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock"/>
                                </div>
                                <div className="form-group col-sm-4">
                                    <label for="ShippingFee" clasName="form-label">Shipping Fee</label>
                                    <input type="text" id="ShippingFee"  defaultValue={this.state.ShippingFee}  name="ShippingFee" class=" w3-input w3-border form-control" aria-describedby="passwordHelpBlock"/>
                                </div>
                            </div>
                            <div className="form-group col-sm-10">
                                 <input type="checkbox" className='mx-2' required name="ChargeShipping" value="true" checked={this.state.ChargeShipping} id="agree" /> 
                                <label for="inputPassword5" clasName="form-label">Do not allow customers to place order below min order amount</label>                
                            </div>
                             <div className="form-group col-sm-10">
                                 <input type="checkbox" className='mx-2' required name="allowcustomers" value="true"  checked={this.state.allowcustomers} id="agree"/> 
                              ...
                              <div className="file-area col-sm-6 my-4" >
                                <div className="form-group">
                                 <label>Additional Note</label>
                                   <div className="form-group">
                                        <textarea id="AdditionalNote" defaultValue={this.state.AdditionalNote} name="AdditionalNote"   rows="5" cols="40"></textarea>
                                  </div>
                               </div>
                           </div>
                       </form>
